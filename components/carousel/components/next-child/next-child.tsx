...
export const NextChild = ({ text, icon, className = "" }: NextChildProps) => {
  const textArray = Array.isArray(text) ? text : [text];

  return (
    <div
      className={`flex flex-col items-center justify-center pb-4 ${className}`}
    >
      <div
      ...
      >
        ...
        {icon && icon}
        {text && (
          <p className="text-primary text-xs font-medium text-center flex flex-col gap-2">
