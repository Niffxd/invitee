...
import { ActivityNavbarProps } from "./types";

export const ActivityNavbar = ({ handleBack }: ActivityNavbarProps) => {
  return (
      ...
      <div className="container mx-auto px-8 py-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted mt-1">Track all your guest list updates</p>
          </div>
        </div>
      </div>
    </header>
