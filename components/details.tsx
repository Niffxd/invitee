    ...
    <div className="relative px-4">
      <div className="relative max-w-3xl mx-auto space-y-3">
        ...
        <div className="space-y-3">
          ...
          >
            <div className="group relative">
              ...
              <div className="relative transform transition-all duration-300 hover:scale-[1.01]">
                <Card className="w-full p-4 backdrop-blur-sm bg-surface/90 border border-border/30 shadow-lg hover:shadow-2xl transition-all duration-300">
          ...
          >
            <div className="group relative">
              <div className="absolute -inset-0.5 bg-linear-to-r from-primary via-accent to-primary rounded-2xl opacity-0 group-hover:opacity-75 blur transition duration-500" />
